...
/**
 * Event DTO for relationship request rejected events.
 * This event is published when a user rejects a relationship request.
 * 
...
@NoArgsConstructor
@AllArgsConstructor
public class RelationshipRequestRejectedEvent {
    ...
    /**
     * User ID of the person who rejected the request
     */
    ...
    /**
     * Optional response message from the rejector
     */
     ...
     */
    @Builder.Default
    private String eventType = "RELATIONSHIP_REQUEST_REJECTED";
